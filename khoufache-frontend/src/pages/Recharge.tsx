...
import tasshilatLogo from '../assets/tasshilat.png';
...
export default function Recharge() {
  ...
  const whatsappMethods = [
    { name: 'كاش بلس', logo: cashPlusLogo },
    { name: 'وفا كاش', logo: wafacashLogo },
    { name: 'أورنج موني', logo: orangeLogo },
    { name: 'إنوي موني', logo: inwiLogo },
    { name: 'تسهيلات', logo: tasshilatLogo },
  ];
        ...
        {activeTab === 'selection' && (
          <div className="recharge-selection-grid animate-fade-in">
            ...
            <div onClick={() => setActiveTab('whatsapp')} className="recharge-card whatsapp">
              ...
              <p>Cash Plus, Wafacash, Orange, Inwi, Tasshilat</p>
            </div>
